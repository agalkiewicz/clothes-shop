...
@Transactional
@Rollback
public class UserPUTUpdateUsernameEndpointTest {
    ...
    @Test
    public void asNonAdminShouldUpdateHisUsername() {
        given()
                .port(port)
                .auth()
                .preemptive()
                ...
                .pathParam("id", 2)
                .body(new UpdateUsernameDto(newUsername))
                .when()
                .put("/{id}/username")
                .then()
                .body("id", equalTo(2))
